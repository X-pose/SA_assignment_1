...
import com.sa.safetynet.emergency.fire.sensor.SensorActivator;
...
public class ClientActivator implements BundleActivator {
    ...
    private SensorActivator fireSensorActivator = new SensorActivator();
    ...
    private void handleEmergency(BundleContext context) {
        ...
        if (!type.equals("-1")) {
            if(type.equalsIgnoreCase("fire")) {
            	try {
    				fireSensorActivator.start(context);
    			} catch (Exception e) {
